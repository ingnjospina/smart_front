                        ...
                        {pronosticos.length ? pronosticos.map((item) => (
                            <tr key={item.pronostico.idpronostico}>
                                ...
                                <StyledTD>
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={sendingEmail === item.pronostico.idpronostico ? '#6c757d' : '#007bff'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
