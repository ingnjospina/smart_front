...
export const NewPronosticoInterruptor = () => {
    ...
    useEffect(() => {
        // Solo habilitar si hay fase detectada Y hay interruptor seleccionado
    ...
    // Reprocesar archivo Excel cuando cambie el interruptor seleccionado
    useEffect(() => {
        // Si hay un interruptor seleccionado, fase detectada y archivo Excel ya cargado
    ...
    const loadFileArchivo2 = (list) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                // Obtener el nombre del interruptor seleccionado
                const interruptorSeleccionado = interruptores.find(
                    i => i.idinterruptores === parseInt(interruptor)
                )
