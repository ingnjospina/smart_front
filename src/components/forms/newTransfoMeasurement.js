...
import { DivForm, InputForm, LabelForm, PButton, SButton, StyledForm, StyledFormSelect, TitleReport } from '../tools/styleContent'
				...
				<Container>
					<StyledForm onSubmit={createMeasurement}>
						...
						<Row xs={12}>
							<Col xs={12} md={6}>
								<Col xs={12}>
									<LabelForm>Cargar Archivo de Medidas Electricas</LabelForm>
								</Col>
								{
									docElec.length > 0 ? (
										<>
							...
							<Col xs={12} md={6}>
								<Col xs={12}>
									<LabelForm>Cargar Archivo de Medidas de Ensayo</LabelForm>
								</Col>
								{
									docEnsayo.length > 0 ? (
										<>
